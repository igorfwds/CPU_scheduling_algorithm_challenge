...
void rate(int total_time,Process *processes, int p_lines ) {
    ...
    printf("%s burst=> %d\t", processes[i].name,processes[i].remaining_burst);
        ...
        //     printf("O next arriving time de %s é %d e o arriving time é %d",processes[1].name, processes[1].next_arriving_time, processes[1].arriving_time );
